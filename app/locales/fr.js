export default {
    ...
    landing_h2: `Vous pouvez parler à des millions de personnes, vous faire de nouveaux amis ou trouver un partenaire.`,
    landing_go: `Avant`,
    landing_caract1: `Ne perdez de temps avec personne !`,
    landing_caract1_desc: `Choisissez vos préférences personnelles pour trouver votre match idéal.`,
    landing_caract1_alt: `Fille sélectionnant ses préférences`,
    landing_caract2: `Vous êtes libre de faire ce que vous voulez`,
    landing_caract2_desc: `Changez de conversation quand vous le souhaitez et rencontrez de nouvelles personnes.`,
    landing_caract2_alt: `Garçon et fille courir joyeusement`,
}